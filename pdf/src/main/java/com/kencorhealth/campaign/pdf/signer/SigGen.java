 ...
 */
public class SigGen extends CreateSignatureBase
{
     ...
     */
    public SigGen(KeyStore keystore, char[] pin)
     ...
     * @throws IOException
     */
    public void signPDF(File inputFile, File signedFile, int pageNumber, Rectangle2D humanRect, String tsaUrl) throws IOException
    {
        this.signPDF(inputFile, signedFile, pageNumber, humanRect, tsaUrl, null);
    }
     ...
     * @throws IOException
     */
    public void signPDF(File inputFile, File signedFile, int pageNumber, Rectangle2D humanRect, String tsaUrl, String signatureFieldName) throws IOException
    {
